      ...
      <div className="mt-8">
        ...
        {currentStep === 3 && (
            <div className="space-y-6">
                ...
                <div className="relative">
                    <input id="licenseExpiry" name="licenseExpiry" type="date" required value={formData.licenseExpiry} onChange={handleChange} placeholder=" " className={`${inputClasses} pt-3`}/>
