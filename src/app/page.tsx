    ...
    <div className="container mx-auto px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Link href="/sacco" className="block">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center transform hover:-translate-y-2 transition-transform h-full">
  ...
  <section id="about" className="py-20">
    <div className="container mx-auto px-6 text-center">
      ...
      <p className="text-gray-600 max-w-2xl mx-auto">
        Safari is a comprehensive platform designed to modernize public transport management in Kenya. Our mission is to bring efficiency, transparency, and convenience to Saccos, vehicle owners, and passengers through technology.
      </p>
    </div>
  </section>
);
...
const Footer = () => (
  <footer className="bg-gray-800 text-white py-8">
    <div className="container mx-auto text-center">
      <p>&copy; {new Date().getFullYear()} Safari. All rights reserved.</p>
    </div>
  </footer>
);
